...
namespace Arcane_Aegis.Network.Handlers
{
    ...
    {
        private readonly Action<CreationOption[], CreationOption[], CreationOption[]> _onData;
        public CreationDataHandler(Action<CreationOption[], CreationOption[], CreationOption[]> onData) => _onData = onData;
        ...
        public void Handle(ref BitBuffer reader)
        {
            ...
            _onData(
                p.Races ?? Array.Empty<CreationOption>(),
                p.Classes ?? Array.Empty<CreationOption>(),
                p.Genders ?? Array.Empty<CreationOption>());
        }
    }
